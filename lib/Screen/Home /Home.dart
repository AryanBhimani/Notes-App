...
class _HomeState extends State<Home> {
  ...
  void _showNotification(String title, String content) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      'notes_channel',
      'Notes Notifications',
      channelDescription: 'Notification when a note is added or updated.',
              ...
              Row(
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    icon: const Icon(Icons.close, color: Colors.white),
                    label:
                        const Text("Cancel", style: TextStyle(color: black)),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.red,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      ...
                      if (note == null) {
                        ...
                        _showNotification("New Note Added", title);
                      } else {
                        await _firestoreService.updateNote(
                          userId,
                          Note(id: note.id, title: title, content: content),
                        );
                        _showNotification("Note Updated", title);
                      }
                      Navigator.pop(context);
                    },
                    icon: const Icon(Icons.save, color: Colors.white),
